	...
	*/
	...
	app.config(['$routeProvider',   function($routeProvider){
		...
		$routeProvider
			...
			.when('/', {
				templateUrl: 'app/src/templates/views/home.html'
			})

			.when('/sacola', {
				templateUrl: 'app/src/templates/views/sacola.html'
			})

			.when('/produtos/promocoes', {
				templateUrl: 'app/src/templates/views/produtos-promocoes.html'
			})

			.when('/produto/codigo/:code', {
				templateUrl: 'app/src/templates/views/produto-interna.html'
			})	

			.otherwise ({
				templateUrl: 'app/src/templates/views/404.html' ,
